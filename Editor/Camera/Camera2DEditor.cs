...
public class Camera2DEditor : Editor {
	public override void OnInspectorGUI() {
		...
		//resolution
		int resW = cam.fixedResolutionWidth, resH = cam.fixedResolutionHeight;

		GUILayout.BeginHorizontal();
		EditorGUILayout.PrefixLabel("Resolution");
		resW = EditorGUILayout.IntField(resW, GUILayout.Width(70.0f));
		GUILayout.Label("x", GUILayout.Width(15.0f));
		resH = EditorGUILayout.IntField(resH, GUILayout.Width(70.0f));
		GUILayout.EndHorizontal();

		cam.fixedResolutionWidth = resW;
		cam.fixedResolutionHeight = resH;
