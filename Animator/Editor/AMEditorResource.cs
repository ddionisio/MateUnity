...
public struct AMEditorResource {
    public const string skinsPathFormat = "Assets/M8/Animator/Skins/{0}.guiskin";

    public const string textureEditorPathFormat = "Assets/M8/Animator/TexturesEditor/{0}.png";

    public const string texturePathFormat = "Assets/M8/Animator/Textures/{0}.png";
    public const string textureMatPathFormat = "Assets/M8/Animator/Textures/{0}.mat";
